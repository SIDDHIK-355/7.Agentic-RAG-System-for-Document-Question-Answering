...
As a trialist you will not be included in profit sharing and other benefits, nor entitled to an overtime, or severance package.
...
If at any time during your onboarding, or any later time, you feel like you need to provide feedback to Nejc and Dejan privately and/or anonymously, please use the feedback form.
...
Before starting the onboarding process, you need to have a GitHub account. Sign up, if you don't have one yet, preferably using a short and lowercase username, with no special characters. To get an idea, here are a few of our usernames: @dmurko, @dz0ny, @marbeann, @zupo.
...
All Niteans issue invoices to the company. The invoice must include: your full name and address, company name and address, date of issue, invoice number, services done, amount and IBAN bank account. You can use an online invoice generator if you don't have your own.
...
For Niteans outside of IBAN area, the bank transfer might be a suboptimal solution due to high bank fees. For these, we use Wise.
