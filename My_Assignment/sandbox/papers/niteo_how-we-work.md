...
Once a month, senior team members have Catchups with everyone on the team to keep themselves in the loop.
...
Task management is done with GitHub Projects. Support handles tickets through Help Scout.
...
We track cash flow with Xero. Finance reports are published as part of the monthly newsletter and are viewable to all full-time Niteans.
