...
1. Formal performance (impact) reviews-reviews>)
...
Our impact review process is explained in detail here
...
At Sourcegraph, we love celebrating and recognizing the events happening in our Teammates’ lives! We celebrate on a day-to-day basis via our ‘#thanks’ channel. Giving recognition to other Teammates is critical for maintaining a positive, innovative company culture. At Sourcegraph, we encourage regular, public recognition via Lattice to our #thanks Slack channel.
...
1. **Submit your feedback in Lattice (Loom)**
   1. Login to Lattice
...
2. **Submit your feedback via Slack in the Lattice app (Loom)**
...
Teammates and Managers are expected to share feedback regularly in a timely manner. The goal is to keep general feedback in private through the Lattice tool and regular 1:1s.. Lattice allows for quick, real-time feedback to be given in both directions (lateral, upwards, & down). The feedback can then be discussed in the next 1:1 or a specific meeting, if necessary.
...
Giving feedback is not to create or resolve conflict. If you are experiencing any form of conflict at work please review our handbook page on conflict resolution. Your People Partner is always a resource as well.
...
1. **Submit your feedback in Lattice (Loom)**
   ...
   5. Type out your feedback in the text box
   6. Select “Send feedback” button
2. **Submit your feedback via Slack Lattice app (Loom)**
   1. Scroll down to the apps section of your Slack menu bar on the left side
   2. Select the Lattice app
   3. In the message box type “help”
   4. Lattice will respond asking what you would like to do, and possible options
...
- **Use the SBI method:** The SBI method is explaining the situation, behavior, and impact it caused, followed by the desired change and expected impact due to the change.
...
1. **Request your feedback in Lattice (Loom)**
   1. Login to Lattice
   2. Select the “give and request feedback” link under your name plate on the homepage
...
2. **Request your feedback via Slack Lattice app (Loom)**
   1. Scroll down to the apps section of your Slack menu bar on the left side
   2. Select the Lattice app
   3. In the message box type “help”
   4. Lattice will respond asking what you would like to do, and possible options
...
Managers have access to sync 1:1 meetings with Lattice templates. The templates are structured to drive productive 1:1 conversations. Managers and Teammates can add agenda items to the agenda in Lattice. Items stored in 1:1s can be referred back to for writing formal reviews.

1. Managers 1:1 setup (loom link)
2. Adding to a 1:1 agenda (loom link)
...
- We expect Teammates to do the following for every 1:1
  ...
  - Add relevant agenda items (loom)
...
- Utilize the “Update” feature to check-in on your team at least monthly.
  - Instructions on how to set up can be found here
...
- How to add agenda items to 1:1s
- How to submit Thanks/praise feedback
- How to submit general feedback

Managers:

- Turning on/off 1:1s as a manager
- Applying 1:1 templates to your direct report relationships
- How to navigate between 1:1s
...
Anyone at Sourcegraph can send a message in the #thanks channel by giving praise in Lattice. Both managers and Teammates are encouraged to use the channel regularly. Managers are reminded to recognize one or more of their Teammates _at least_ on a monthly basis.