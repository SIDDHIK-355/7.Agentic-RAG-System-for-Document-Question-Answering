We're an all-remote company that allows people to work from almost anywhere in the world. We hire great people across many locations, so it's important for us to practice clear communication in ways that help us stay connected and work more efficiently.
...
1. **Kindness Matters.** You are looking at a screen, but you are really talking to a person. If you wouldn't say it to someone face to face, do not send it to them in a Slack message.
...
1. **Always Adhere to our Anti-Harassment Policy and GitLab Code of Business Conduct and Ethics.** Everyone should be comfortable in their work environment.
 ...
 *Team Member Resource*: To learn more on when to use asynchronous and synchronous communication, review this full overview of async vs. sync with additional guidance.
...
If there is an issue to raise regarding someone's communication or conduct, team members should follow the process for raising communication concerns by sharing their concern with their manager or, if preferred, email Team Member Relations (teammemberrelations@gitlab.com) directly.

### Communicating When Using Generative AI Tools

1. **Own your output**: You are responsible for the accuracy, appropriateness, and value of any content you share, regardless of how it was created. As the ultimate author, you should read, understand, and refine comments, code or other artifacts before asking others to review.
   - **Verify before sharing**: AI can generate plausible but incorrect information. Always verify facts, code functionality, and technical details before posting.
   - **Use inclusive language**: Review AI outputs for bias and ensure they align with our Diversity, Inclusion & Belonging value.
   - **Keep broadcasts short**: AI tools can generate verbose and repetitive content. Edit for brevity and clarity, especially in one-to-many communications. Optimize for efficiency for the right group. Consider your audience's time when deciding what to share.
1. **Protect confidential information**: Be aware of Data Classification Standards for the data and AI tooling you're using. Use only approved internal tools for sensitive content.
1. **Maintain authenticity**: Ensure your communications reflect genuine human judgment and align with our values. This is especially important in customer interactions and when providing feedback.
1. **Don't use AI disclosure to deflect responsibility**: Consider your intent before mentioning AI use. Transparency should add value, not serve as a disclaimer reducing your accountability. If you're mentioning it to hedge against errors, your content may not be ready to share.

AI tools can enhance efficiency, but they don't reduce your responsibility to communicate effectively and professionally.

If you're a recipient of content you think falls short of this guidance (sometimes called "AI slop"), operate on our principles of "assume positive intent", "negative feedback is 1-on-1", and "give feedback effectively".
...
1. **PR risk:** Remember that anything you document could ultimately be shared/viewed externally. Consider that a discussion in a public MR or issue is a demonstration of our values to those outside of GitLab who are looking to learn more about how we collaborate.
...
1. Discussion in issues or Merge Requests is preferred over everything else. If you need a response urgently, you can Slack someone with a link to your comment on an issue or merge request, asking them to respond there, however be aware that they still may not see it straight away. See Slack for more.
...
1. Avoid creating private groups for internal discussions:
   ...
   1. History is lost when leaving the group or after 90 days.
...
1.  Use low-context communications by being explicit in your communications. We are a remote-only company, located all over the world. Provide as much context as possible to avoid confusion. Relatedly, we use ubiquitous language for communication efficiency.
...
1. Consult our tips for better writing.
...
If you are unsure whether the behavior you experience is a bug, you may ask in the Slack channel #is-this-known.
...
- Asking in a single channel helps discoverability, duplicated efforts and reduces noise in other channels.
  Please refrain from asking in general purpose channels like #frontend, #backend, #development or #questions.
- For critical production issues, check if there is a related ongoing incident in `#incidents-dotcom`. If there is none, please report an incident.
...
As we continue to build on inclusion, recognition is a key and transformative tactic. Thanking team members provides an opportunity for them to be recognized for their contributions, influences engagement behavior, and acknowledges to team members their work is seen.
...
1. We generally avoid recognizing people for working outside of working hours to minimize the pressure to do so. At times, team members may decide to work outside their core working hours to complete a task or attend an event. When team members work outside their core hours to deliver results, we acknowledge their flexibility and contribution transparently. It is appropriate to thank team members who flex their schedule to meet GitLab goals whether that's resolving a customer emergency, accommodating global team meetings, or delivering on a critical deadline.
1. Do not thank the CEO or other executives for something that the company paid for, thank GitLab instead.
1. To thank someone who is not a team member, nominate them as a Notable Contributor.
...
1. Utilize Time Off by Deel to keep other GitLab team members aware of your planned time away within Slack.
...
1. Starting with a Merge Request is part of Handbook First and helps ensure the handbook is up-to-date when a decision is made. It is also how we make it possible for Everyone to Contribute. This is true, not just for updating the handbook but for updating all things.
...
1. Not every solution will solve the problem at hand. Keep discussions focused by **defining the problem first** and **explaining your rationale** behind the Minimal Valuable Change (MVC) proposed in the MR.
...
1. Have a **bias for action** and do not aim for consensus. Every MR is a proposal, if an MRs author isn't responsive take ownership of it and complete it. Some improvement is better than none.
...
1. Submit the **smallest** viable and valuable thing. When proposing a change, submit the smallest reasonable commit, put suggestions for other enhancements in separate issues/MRs and link them. An MR can start off as only a problem description and TODO comments. If you're new to GitLab and are writing documentation or instructions, submit your first merge request for at most 20 lines.
...
1. Make a conscious effort to **prioritize** your work. The priority of items depends on multiple factors: Is someone waiting for the answer? What is the impact if you delay it? How many people does it affect, etc.? This is detailed in Engineering Work flow.
...
1. Respond to comments within a **threaded discussion**. If there isn't a discussion thread yet, you can use the Reply to comment button from the comments to create one. This will prevent comments from containing many interweaved discussions with responses that are hard to follow.
...
1. If you have received any feedback or questions on your MR, try to acknowledge comments as that's how we ensure we create an environment of belonging for all team members. Merging your MR as-is without giving an answer or any response makes the commenters feel their opinions are unheard. If you are the Directly Responsible Individual (DRI) who does not have to make a fast decision, you can choose not to change your MR, but you should acknowledge the comments or feedback, consider if they warrant a change to your MR, and say why, not just what.
...
<i>**Pro Tip:**</i> When creating a Merge Request you can add `closes: #[insert issue number here]` and when the Merge Request is merged, the issue will automatically close. You can see an example of this here. **Note:** Automatic issue closing is disabled on some projects.
...
1. When cross-linking issues or MRs, include a preview of the content you are linking, to facilitate low-context communication:
...
1. When providing links to specific lines of code relevant to the issue, **always use a permalink** (a link to a specific commit for the file). This ensures that the reference is still valid if the file changes. For more information, see Link to specific lines of code.
1. Prioritize your work on issues in the current milestone.
1. Use the public issue trackers on GitLab.com for everything since we work out in the open. Issue trackers that can be found on the relevant page in the handbook and in the projects under the gitlab-com group.
...
1. Do not close an issue until it is **done**. It's okay to explicitly ask if everyone is on board and in agreement on how to move forward, whether to iterate, close the open issue, or create a subsequent MR to implement a MVC.
1. Once a feature is **done**, update the description to add a link to the corresponding documentation. When using a Search Engine, issues often appear before documentation pages, which makes it harder to find the relevant information about the feature.
...
1. If the content within a public issue transitions to become what is deemed confidential non-public information, the issue may be made confidential.
1. If the content of a public issue draws comments that are deemed in violation of our code of conduct the issue may be locked and may undergo moderation.
...
It is an **announcement only** channel, meaning that communications need to be approved before they can be posted. To minimize noise, announcements made in `#company-fyi` should not be duplicated in `#whats-happening-at-gitlab`. Be mindful of the attention economy.
...
1. For meetings that are scheduled with Zoom:
   - After reviewing our Zoom handbook page, if you have additional questions, please contact us via the Compass app in Slack (type "Compass" in the top search bar to find it) or it-help@gitlab.com.
...
After GitLab releases a new version every month, we have a
...
Both the retrospectives and kickoffs are live streamed to our GitLab Unfiltered YouTube channel
and posted to our Unfiltered YouTube channel.
...
This aligns with how we work since everything at GitLab is public by default.
...
Corporate marketing maintains guidelines on GitLab's tone of voice.
...
Please keep GitLab values in mind when communicating directly with other team members.
...
For additional questions, please address in the issue.
...
Join the Slack Down! room on Hangouts Chat.
...
1. You can set the notifications on a Google Doc so you only get emailed when someone tags you directly instead of getting emails for every comment. Click on "notifications" and select "Only yours". By the way, when you create the doc, it defaults to All, but when you are just shared with it, it defaults to Only yours. There is no global default.<br>
...
the general number (+1-650-667-4852), but be aware that this number simply guides to a voice message that refers the caller back to contacting us via email.
