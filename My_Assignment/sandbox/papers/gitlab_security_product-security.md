...
|---|---|---|
| Security Platforms & Architecture (SPA) | If you're building features or AI capabilities | SPA, AppSec |
| Infrastructure Security (InfraSec) | If you're working on infrastructure | InfraSec, Data Security |
| Vulnerability Management, PSIRT, and ProdSecEng | If you're working around vulnerability data, bug bounty, or security tooling | Vuln MGMT, PSIRT, ProdSecEng |
...
- **Security Platforms & Architecture**: ~"Security-Platforms-Architecture Team"
