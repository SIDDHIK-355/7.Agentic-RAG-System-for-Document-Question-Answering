...
At pay review time, we compare your step to peers in similar roles at PostHog and decide whether to bump it up. Here's how to move from one step or level to another.
...
-   For UK-based team members, eligible options are part of the EMI share options scheme or the CSOP scheme, which are tax-advantaged
