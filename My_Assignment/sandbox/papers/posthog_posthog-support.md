...
To set up `@SupportHog` in customer channels, see the sales/CS handbook page on customer channels.
...
- **`support_sme_*`** — applied based on the SME handbook groupings.
...
The direction for support at PostHog is set out in Stop adding AI between you and your customers — support at PostHog stays human.
