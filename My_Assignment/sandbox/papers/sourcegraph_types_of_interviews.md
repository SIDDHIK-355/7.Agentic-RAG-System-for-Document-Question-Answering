...
- Duration: 30-minutes.
- Details: this interview is focused entirely on our values and how your views and experiences align with them. Our values are key to our success as individuals and as a company, so please read more about them here prior to your interview.
...
- Team org: Sales team and Marketing team
- Publicly referenceable customer logos
- Everything at Sourcegraph and our handbook should be assumed to be accurate and up to date.
...
- Here are some repos you could use
  ...
  - https://sourcegraph.com/github.com/vuejs/vue
...
1. https://docs.sourcegraph.com/
2. Sourcegraph Cody
   1. Cody for Web
   2. Download installers
3. https://sourcegraph.com/search
4. https://docs.sourcegraph.com/api/graphql
5. Working with the SG GraphQL API**
...
- Resources for Hiring Managers and Teammates
...
1. Choose one of the following handbook pages to review: Impact Reviews  **_or_** Onboarding
...
- Details: A Sourcegraph teammate will ask experience and behavioral based questions about your skills, values, and work history in order to gauge whether they're aligned with the requirements of the role. The goal of the interview is to:
  ...
  2. Take a deep dive into your background from past to present with the goal of uncovering the motivation behind your decision making, strengths, weaknesses, and accomplishments in past roles.
  3. Get a high level understanding of how your views and experiences align with our values.
...
- Cody June 2023 release: Better codegen, more recipes, more context, more editors
- Sourcegraph 5.1 release
- Cody 5.1 release video
