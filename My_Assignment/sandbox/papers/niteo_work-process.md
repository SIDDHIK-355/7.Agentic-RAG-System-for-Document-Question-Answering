...
Big cleanups (of code, documentation, or anything else) happen rarely as they are hard to organize and motivate for. Instead of doing big cleanups every few months (years?) when pain levels are high enough, we prefer to do constant tiny improvements with an approach called Continual Improvement.
