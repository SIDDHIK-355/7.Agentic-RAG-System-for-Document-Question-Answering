...
Sourcegraph is an all-remote company. This means we all need to make an effort to travel to meet up in person and spend quality time with other Teammates all around the world.
...
Unsure how much budget you have left? Click here!
...
For Teammates with business-related travel requirements aligned with Company goals, trips will be fully paid pending manager/exec approval in addition to above budgets. Please note you cannot combine the teammate in-person gathering budget with 4 trips.
...
Navan is our source of truth for booking travel. All teammate travel must be booked through this platform to be considered within your travel budgets. Please refer to our Navan guide which covers topics including: account setup, how to book a trip, bookings policy, etc.
...
- You must notify People Ops (people-ops@sourcegraph.com) so that we can advise on next steps for notifying other potentially affected teammates. _Please note that no personal names will be shared with teammates in regards to any communications around COVID-19 exposures._
...
- Escape Experiences (virtual escape room)
