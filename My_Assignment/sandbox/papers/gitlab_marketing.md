...
Each quarter, the Marketing team creates OKRs (Objectives and Key Results).
...
| Rules on legally compliant language for marketing communications (_internal only_) | `#mktgops` | Marketing Ops |
...
- Technical community posts/tutorials: Developer Advocacy and Blog editorial team
...
We are happy to sponsor events and meet-ups where a marketing benefit exists, subject to approval by Regional Marketing Managers. These sponsorships may be in cash or in kind, depending on individual circumstances.
...
- `#developer-advocacy`: Discuss the latest tech in DevSecOps and Cloud-Native with the Developer Advocacy team. You can request speakers, customer consultancy and technical content collaboration and guidance.
...
- `#regional-partner-marketing`: Discuss, ask questions, stay up-to-date on events that are being organized by Regional Marketing, and Channel Marketing
...
- `#developer-advocacy-updates`: automated workflows to post GitLab blog posts, Developer Relations social shares, competitive insights, Common Room updates, etc.
...
### Product & Technical Marketing (PTM) User Groups

<a id="ptm-user-groups"></a>

These groups are intended to make it easier to tag the right team quickly in Slack, while the matching Google Groups help with meetings and org hygiene.

| Slack group | When to use it |
| ------ | ------ |
| `@ptm-leadership` | Tag for org-wide questions, leadership alignment, and cross-functional escalations within PTM. |
| `@ptm-content-ops-strategy` | Tag for content planning, editorial operations, and strategic content program support. |
| `@ptm-dev-advocacy` | Tag for developer relations, community engagement, and technical advocacy programs. |
| `@ptm-product-solutions-marketing` | Tag for product positioning, go-to-market strategy, and solutions marketing support. |
| `@ptm-tech-writing-globalization` | Tag for technical documentation, content localization, and globalization program support. |
...
The team includes Regional Marketing, Global Channel Marketing, Corporate Events, Account Based Marketing, Integrated Campaigns, Lifecycle Marketing, Digital Strategy and Digital Experience.
