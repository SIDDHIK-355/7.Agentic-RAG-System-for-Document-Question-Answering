...
Recruitee is an all-in-one recruiting SaaS. We use it to source and evaluate candidates, track applicants and keep all information in one place so we can then make informed decisions on who to hire.
...
**1. Sourcing**
   ...
   * A good checklist to run through to make sure we're not missing any key information: Tech Ladies job posting best practices
...
**7. Hired**
   ...
   The candidate accepts our offer, and we start the [onboarding process] by creating the onboarding issue.

[trial period]: https://github.com/teamniteo/handbook/blob/main/5_People/onboarding.md#trial-period
[onboarding process]: https://github.com/teamniteo/handbook/blob/main/5_People/onboarding.md
