...
- EBN project: `teamniteo/easyblognetworks`
- Niteo House project: `teamniteo/house`
- Pareto project: `teamniteo/pareto`
- SEO Domain Finder project: `teamniteo/sdf`
- Company issues: `teamniteo/operations`
...
To make the Stories more inclusive, we prefer using Singular they instead of `he`, `himself`, etc.
...
A Story Point is an arbitrary measure used by Scrum teams to indicate the effort required to implement a User Story. Story points are not a representation of time, but rather a combination of Risk, Repetition, and Complexity. However, we typically think of one story point as the amount of work a person can do in one day.
...
*This snippet can be added to GitHub saved replies for reuse.*
